...
<head>
    ...
    <link rel="stylesheet" type="<?= $urlval?>text/css" href="css/dumpbutton.css">
    ...
    <script src="<?= $urlval?>js/section-navigation.js" defer></script>
    ...
    <script src="<?= $urlval?>js/refresh-cards.js" defer></script>
    <script src="<?= $urlval?>js/refresh-dumps.js" defer></script>
    ...
    <nav class="sidebar">
        <ul>
            ...
            <?php if ($visibility['My Orders'] === 1): ?>
                <li><a href="<?= $urlval?>pages/my-orders.php" id="my-orders-nav"><i class="fas fa-box"></i> My Orders</a></li>
            <?php endif; ?>
            <?php if ($visibility['Credit Cards'] === 1): ?>
                <li><a href="<?= $urlval?>pages/credit-cards.php" id="credit-cards-nav"><i class="far fa-credit-card"></i> Credit Cards</a></li>
            <?php endif; ?>
            <?php if ($visibility['Dumps'] === 1): ?>
                <li><a href="<?= $urlval?>pages/dumps.php" id="dumps-nav"><i class="far fa-credit-card"></i> Dumps</a></li>
            <?php endif; ?>
            <?php if ($visibility['My Cards'] === 1): ?>
                <li><a href="<?= $urlval?>pages/my-cards.php" id="my-cards-nav"><i class="fas fa-id-card"></i> My Cards</a></li>
            <?php endif; ?>
            <?php if ($visibility['My Dumps'] === 1): ?>
                <li><a href="<?= $urlval?>pages/my-dumps.php" id="my-dumps-nav"><i class="fas fa-id-card"></i> My Dumps</a></li>
            <?php endif; ?>
            <li><a href="<?= $urlval?>pages/add-money/index.php" id="add-money-nav"><i class="fas fa-dollar-sign"></i> Add Money</a></li>
            <li><a href="<?= $urlval?>pages/rules.php" id="rules-nav"><i class="fas fa-gavel"></i> Rules</a></li>
            <li>
                <a href="<?= $urlval?>pages/support.php" id="support-link">
            ...
            <?php if ($user['seller'] == 1): ?>
                <li><a href="<?= $urlval?>pages/seller-stats.php" id="seller-stats-nav"><i class="fas fa-chart-bar"></i> Seller Stats</a></li>
            <?php endif; ?>
        </ul>
    </nav>
