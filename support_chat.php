        ...
        <div class="ticket-list">
            <?php if (!empty($tickets)): ?>
                <?php foreach ($tickets as $ticketId => $messages): ?>
                    ...
                    <div class="ticket-summary" data-ticket-id="<?php echo htmlspecialchars($ticketId); ?>" onclick="toggleConversation(<?php echo htmlspecialchars($ticketId); ?>)">
                    ...
                    <div class="ticket-conversation" id="conversation-<?php echo htmlspecialchars($ticketId); ?>" style="display: none;">
    ...
    <?php endforeach; ?>
                        ...
                        <div class="reply-control-row">
                            ...
                            <div class="admin-controls">
                                <?php if ($messages[0]['status'] === 'open'): ?>
                                    <button onclick="closeTicket(<?php echo htmlspecialchars($ticketId); ?>)" class="close-ticket">Close Ticket</button>
                                <?php endif; ?>
                                <button onclick="deleteTicket(<?php echo htmlspecialchars($ticketId); ?>)" class="delete-ticket">Delete Ticket</button>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
                <center><p>No support tickets found.</p></center>
            <?php endif; ?>
        </div>
