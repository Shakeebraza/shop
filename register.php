...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="register.php" id="registerForm">
            ...
            <input type="text" name="contact_value" id="contact_value" placeholder="Enter your Jabber email"
                pattern="^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$" required>

            <label for="password">Password</label>
            <input type="password" name="password" id="password" required>
            <ul id="passwordRules"
                style="list-style-type: none; padding: 0; display: none; flex-wrap: wrap; gap: 10px;">
            ...
            <label for="secret_code">Secret Code
                <span class="help-container">
                    ...
                    <div class="popup-message" id="popupMessage">
                        Set your secret code from 6 digits, and keep it secure. You will need this code when you want to
                        change or edit your account profile.
                    </div>
                </span>
            </label>
